...
selectColDf = function(x)  {
  x %>%
    dplyr::select(plotId, siteId, cntryId, lastNm, submtNm, lat, lon, year, month, day, biome, distur, fireYr, paired, gtProbe, hitRock, orgDpth, srfH2O, topoPos, slope, vegCvr, msrDoy, msrType, msrDpth, resBiomNm, resBiomeNm, resEcId, resId, resName, resRelm, wwfBiom, wwfEcId, wwfId, wwfName, wwfNum, wwfRelm, contains("temperature_2m")) %>%
