...
```{r}
( df2015 = f2015 %>%
  dplyr::select(plotId, siteId, cntryId, lastNm, submitNm, lat, lon, year, month, day, biome, distur, fireYr, paired, gtProbe, hitRock, orgDpth, srfH2O, topoPos, slope, vegCvr, msrDOY, msrType, msrDepth, OBJECTID, ECO_NAME, REALM, BIOME_1, ECO_NUM, ECO_ID, X20150401_temperature_2m:X20151229_temperature_2m) %>%
    mutate(id = row_number()) )
```
