...
### Check NAs
```{r}
dataCombine %>% filter_at(vars(A_sum, A, B_sum, B, C, AdjALT), all_vars(is.na(.)))
```

```{r}
write.csv(dataCombine, file = "../outputs/dataCube/DatacubePermafrostFirePredicted.csv")
```
