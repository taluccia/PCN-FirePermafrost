...
```{r}
#dataCube %>% filter(if_any(paired, is.na))
#dataCube %>% filter(if_any(hitRock, is.na))
dataCube %>% filter(hitRock == "y" ) 
dataCube %>% filter(gtProbe == "y" ) 
```
