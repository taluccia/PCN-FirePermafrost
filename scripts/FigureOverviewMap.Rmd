...
legendRightWwf = cowplot::get_legend(wwfLegendRight)
```

```{r}
legend_permafrostBottom = cowplot::get_legend(permafrostLegendBottom)
legendBottomWwf = cowplot::get_legend(wwfLegendBottom)
...
## Combine Bottom Legends for WWF
...
MapBottomLegendResolve = ggdraw(xlim = c(0, 6), ylim = c(0, 6)) +
  ...
  draw_image("../images/legendBottomResolve.PNG", scale = 0.85, x = .2, y = -0.1, width = 6, height = 1) 
```
