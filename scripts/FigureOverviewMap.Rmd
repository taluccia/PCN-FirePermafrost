...
( overviewMap = ggplot() +
 ...
 geom_sf(data=artic_pp, fill=NA, colour = "#2F4F4F", lwd=1, linetype="dashed") +
  ...
  new_scale_fill() +
   geom_sf(data = wwf, aes(fill = ECO_NAME, color=ECO_NAME, size=prct),  pch=21, stroke =1.8, alpha=.65) +
...
ggplot() +
 ...
 geom_sf(data=artic_pp, fill=NA, colour = "#2F4F4F", lwd=1, linetype="dashed") +
  ...
  new_scale_fill() +
  geom_point(data = wwf_pp, aes(x=x, y=y, fill = ECO_NAME, color=ECO_NAME, size=prct, label=prct),  pch=21, stroke =1.8, alpha=.65) +
   geom_text(data = wwf_pp, aes(x=x, y=y,label=prct),  size=2) +
    scale_fill_manual(values=ecoPalette) +
  scale_color_manual(values=c("black", "black", "black","black","black","black","black","black","black","black","black","black","black")) +
  scale_size(range = c(6, 11), # point size range
             breaks = c(1, 10, 20, 30, 40 , 50), limits = c(0, 50))+
...
( ecozoneLegendB = ggplot() +
 ...
 new_scale_fill() +
  ...
  theme(legend.position = "bottom",
        ...
        axis.title.x = element_blank(), 
        axis.title.y = element_blank()) +
  guides(color = guide_legend(title.position = "top", nrow=3,bycol=TRUE, override.aes = list(size = 4)),
         fill = guide_legend(title.position = "top", nrow=3,bycol=TRUE, override.aes = list(size = 4))) 
)
...
legendEco = cowplot::get_legend(ecozoneLegendR)
